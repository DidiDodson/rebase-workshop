 ...
 * Troubleshooting
 ...
 INTRODUCTION
------------
This is just a base template for a README with `Lorem Ipsum FACTO`, used for the [Rebase Workflow Workshop](https://mod4.turing.edu/lessons/rebase-workflow-workshop.html) session.
